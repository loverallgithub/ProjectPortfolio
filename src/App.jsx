...
const projectTranslations = {
  en: {
    consas: { title: 'The CONSAS Project', subtitle: 'Consolidated SAS Architecture', tagline: 'How I rewrote Unix kernel code, saved $17 million per year, and built infrastructure that\'s still running 25 years later.', quote: '"The only formal recognition was the offer of a permanent role."' },
    recovery: { title: 'The $3 Trillion Recovery', subtitle: 'Unprecedented Database Reconstruction', tagline: 'How we rebuilt a petabyte-scale database that IBM said couldn\'t be recovered.', quote: '"Title doesn\'t mean you\'re above the work."' },
    restatement: { title: 'The 7-Year Earnings Restatement', subtitle: 'Enterprise-Wide Financial Reconstruction', tagline: 'How we rebuilt an entire enterprise\'s infrastructure and delivered the largest financial restatement in GSE history.', quote: '"Resourcefulness is the intersection of preparation and knowledge."' },
    setclear: { title: 'SetClear Global Settlement', subtitle: 'Bloomberg/Calyon Joint Venture', tagline: 'How my team became the only one to deliver on a multi-team joint venture.', quote: '"We were the only ones who delivered."' },
    homedepot: { title: 'Home Depot Enterprise BI', subtitle: 'Microsoft\'s First Enterprise BI Accelerator', tagline: 'How I led the implementation of Microsoft\'s first enterprise-scale BI platform.', quote: '"When Microsoft\'s CEO hand-delivers your beta code, you know you\'re building something that matters."' },
    tokiomarine: { title: 'Tokio Marine HCC Lakehouse', subtitle: 'First Medallion Architecture on Snowflake', tagline: 'How I pioneered lakehouse architecture before the term existed.', quote: '"Being an early adopter can drive significant improvements."' },
    merkle: { title: 'Merkle Customer Data Platform', subtitle: 'Predictive Analytics & Customer Segmentation', tagline: 'How I leveraged deep MicroStrategy expertise for major retail CDP customers.', quote: '"Deep platform expertise transforms good campaigns into great ones."' },
    globaldata: { title: 'Strategic Alliance Architecture', subtitle: 'Building the Bridge Between Partners & Customers', tagline: 'How I carved out my own role at a centuries-old data company.', quote: '"I treat every role as someone giving me the keys to my own franchise."' },
    ipg: { title: 'Healthcare Claims Analytics Platform', subtitle: 'Transforming Insurance Carrier Intelligence', tagline: 'How I rescued a failing analytics platform and had every major carrier subscribing within 2 months.', quote: '"When I arrived, the entire platform was a facade. Two months later, every carrier had subscribed."' }
  },
  nl: {
    consas: { title: 'Het CONSAS Project', subtitle: 'Geconsolideerde SAS Architectuur', tagline: 'Hoe ik Unix kernel code herschreef en $17 miljoen per jaar bespaarde.', quote: '"De enige formele erkenning was het aanbod voor een vaste rol."' },
    recovery: { title: 'Het $3 Biljoen Herstel', subtitle: 'Ongekende Database Reconstructie', tagline: 'Hoe we een database herbouwden die IBM onherstelbaar noemde.', quote: '"Titel betekent niet dat je boven het werk staat."' },
    restatement: { title: 'De 7-Jarige Herformulering', subtitle: 'Bedrijfsbrede Financiële Reconstructie', tagline: 'Hoe we de volledige infrastructuur van een onderneming herbouwden.', quote: '"Vindingrijkheid is het kruispunt van voorbereiding en kennis."' },
    setclear: { title: 'SetClear Wereldwijde Afwikkeling', subtitle: 'Bloomberg/Calyon Joint Venture', tagline: 'Hoe mijn team de enige werd die leverde in een multi-team joint venture.', quote: '"Wij waren de enigen die leverden."' },
    homedepot: { title: 'Home Depot Enterprise BI', subtitle: 'Microsoft\'s Eerste Enterprise BI Accelerator', tagline: 'Hoe ik Microsoft\'s eerste enterprise-schaal BI platform leidde.', quote: '"Als Microsoft\'s CEO je beta code aflevert, weet je dat je iets belangrijks bouwt."' },
    tokiomarine: { title: 'Tokio Marine HCC Lakehouse', subtitle: 'Eerste Medallion Architectuur op Snowflake', tagline: 'Hoe ik lakehouse architectuur pionierde voordat de term bestond.', quote: '"Een early adopter zijn kan significante verbeteringen opleveren."' },
    merkle: { title: 'Merkle Customer Data Platform', subtitle: 'Predictieve Analytics & Klant Segmentatie', tagline: 'Hoe ik diepe MicroStrategy expertise inzette voor grote retail CDP klanten.', quote: '"Diepe platform expertise transformeert goede campagnes in geweldige."' },
    globaldata: { title: 'Strategische Alliantie Architectuur', subtitle: 'De Brug Bouwen Tussen Partners & Klanten', tagline: 'Hoe ik mijn eigen rol uitsneed bij een eeuwenoud databedrijf.', quote: '"Ik behandel elke rol als iemand die me de sleutels geeft van mijn eigen franchise."' },
    ipg: { title: 'Zorgclaims Analytics Platform', subtitle: 'Transformatie van Verzekeraar Intelligentie', tagline: 'Hoe ik een falend analytisch platform redde en binnen 2 maanden elke grote verzekeraar als abonnee had.', quote: '"Toen ik aankwam was het hele platform een façade. Twee maanden later had elke verzekeraar zich geabonneerd."' }
  }
};
